...
@implementation MWZUISceneCoordinator
...
-(void) setDefaultScene:(MWZUIDefaultScene*)defaultScene {
    _defaultScene = defaultScene;
    [_defaultScene addTo:_containerView];
}

-(void) setSearchScene:(MWZUISearchScene*)searchScene {
    _searchScene = searchScene;
    [_searchScene addTo:_containerView];
    [_searchScene setHidden:YES];
}

-(void) setDirectionScene:(MWZUIDirectionScene*)directionScene {
